basis_sets = {
    ...
    "SARC (Segmented all-electron relativistically contracted) basis sets": {
    ...
    "Correlation-consistent basis sets": {
        ...
        "cc-pwCV6Z": "Core-polarized with weighted core functions",
        ...
        "aug-cc-pwCV6Z": "As above, augmented with diffuse functions",
        ...
        "cc-pV6(+d)Z": "With tight d functions"}
