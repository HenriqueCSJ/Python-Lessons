...
def deal_card(frame):
    ...
    # Add the image to a lable and display the label
...
def score_hand(hand):
    # Calculates the totalsocre of all cards in the list
    # Only one ace can have the value 11 and this will be reduced to one if
    # the hand will bust
    score = 0
    ace = False
...
def new_game():
    ...
    # Embed the frame to hold the card images
...
# Create a new deck of cards and shuttle them
